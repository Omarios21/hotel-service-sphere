...
const EditableTransactionManager: React.FC = () => {
          ...
          <CardHeader className="flex flex-row items-center justify-between bg-gradient-to-r from-primary/10 to-transparent">
            ...
            {selectedTransactions.length > 0 && (
              ...
              >
                ...
                >
                  <Check className="mr-1 icon-size-16" />
                  Update Status
                </Button>
                <Button
                  variant="outline"
                  ...
                  className="border-primary/20 hover:border-primary/40"
                >
                  <Lock className="mr-1 icon-size-16" />
                  Update Admin Status
                </Button>
              </motion.div>
            )}
              ...
              <div className="px-6 pt-2 border-b">
                <TabsList className="mb-2 w-full justify-start h-10 p-1 bg-secondary/30">
                  ...
                  <TabsTrigger value="analytics" className="flex gap-2 data-[state=active]:bg-background">
                    <BarChart className="icon-size-16" />
                    Analytics
                  </TabsTrigger>
                </TabsList>
              </div>
                  ...
                  <div className="flex flex-col gap-6">
                    <div className="flex flex-wrap gap-4 items-center justify-between">
                      <div className="relative w-full md:w-64">
                        <Search className="absolute left-2 top-2.5 icon-size-16 text-muted-foreground" />
                        <Input
                      ...
                      <Button
                        ...
                        className="border-primary/20 hover:border-primary/40"
                      >
                        <Filter className="mr-1 icon-size-16" />
                        Filters
                        <ChevronDown className={`ml-1 transition-transform icon-size-14 ${showFilters ? 'rotate-180' : ''}`} />
                      </Button>
                    </div>
                    ...
                    {showFilters && (
                      ...
                      >
                        ...
                        >
                          <ArrowDownUp className="icon-size-16" />
                        ...
                        <Card className="bg-primary/5 border-primary/10 hover:shadow-lg transition-all">
                          <CardContent className="flex items-center justify-between pt-6">
                            ...
                            <div className="bg-primary/10 p-3 rounded-full">
                              <FileText className="icon-size-20 text-primary" />
                            </div>
                          </CardContent>
                        </Card>
                      </motion.div>
                        ...
                        <Card className="bg-green-500/5 border-green-500/10 hover:shadow-lg transition-all">
                          <CardContent className="flex items-center justify-between pt-6">
                            ...
                            <div className="bg-green-500/10 p-3 rounded-full">
                              <DollarSign className="icon-size-20 text-green-500" />
                            </div>
                          </CardContent>
                        </Card>
                      </motion.div>
                        ...
                        <Card className="bg-yellow-500/5 border-yellow-500/10 hover:shadow-lg transition-all">
                          <CardContent className="flex items-center justify-between pt-6">
                            ...
                            <div className="bg-yellow-500/10 p-3 rounded-full">
                              <Clock className="icon-size-20 text-yellow-500" />
                            </div>
                          </CardContent>
                        </Card>
                      </motion.div>
                        ...
                        <Card className="bg-blue-500/5 border-blue-500/10 hover:shadow-lg transition-all">
                          <CardContent className="flex items-center justify-between pt-6">
                            ...
                            <div className="bg-blue-500/10 p-3 rounded-full">
                              <User className="icon-size-20 text-blue-500" />
                            </div>
                          </CardContent>
                        </Card>
                      </motion.div>
                                    ...
                                    <TableRow key={transaction.id}>
                                      ...
                                      <TableCell>
                                        <div className="flex items-center">
                                          <Calendar className="icon-size-16 mr-2 text-muted-foreground flex-shrink-0" />
                                      ...
                                      <TableCell>
                                        <div className="flex items-center">
                                          <User className="icon-size-16 mr-2 text-muted-foreground flex-shrink-0" />
                                      ...
                                      <TableCell className="max-w-xs truncate">
                                        {transaction.description ? (
                                          <div className="flex items-center">
                                            <FileText className="icon-size-16 mr-2 text-muted-foreground flex-shrink-0" />
                                      ...
                                      <TableCell>
                                        <div className="flex items-center font-medium">
                                          <DollarSign className="icon-size-16 mr-1 text-green-500 flex-shrink-0" />
                                          ...
                                          {transaction.status === 'pending' && (
                                            <>
                                              <Button 
                                                ...
                                                title="Mark as Paid"
                                              >
                                                <CheckCircle2 className="icon-size-16" />
                                              </Button>
                ...
                <TabsContent value="analytics" className="mt-0">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <Card className="lg:col-span-2">
                      <CardHeader>
                        <CardTitle>Transaction Amount by Location</CardTitle>
                      </CardHeader>
                      <CardContent>
                        <div className="h-80">
                          <ResponsiveContainer width="100%" height="100%">
                            ...
                            >
                              <XAxis dataKey="name" />
                              <YAxis />
                              <RechartsTooltip formatter={(value: any) => [formatPrice(value), 'Amount']} />
                              <Legend />
                ...
                {transactionLogs.map((log) => (
                  <div key={log.id} className="border rounded-lg p-3 bg-secondary/10">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <ArrowDownUp className="icon-size-16 text-muted-foreground" />
...
export default EditableTransactionManager;
